...
export function CreateTripPage() {
    ...
    function removeEmailFromInvite(emailToRemove: string) {
        const newEmailList = emailsToInvite.filter(toInvite => toInvite !== emailToRemove)
    ...
    return (
        <div className="h-screen flex items-center justify-center bg-bgPattern bg-no-repeat bg-center">
